...
class BertNerTagger(pl.LightningModule):
    ...
    def get_parser():
        ...
        parser.add_argument('--random_int', type=str, default='1', help='play the role of random seed to name the output dir', )
    ...
    def on_validation_epoch_end(self):
        ...
        if f1 > self.args.best_dev_f1:
            ...
            file_prob1 = self.args.default_root_dir + '/' + self.args.modelName + '_prob_unlabel_ep{:02d}.pkl'.format(self.args.max_epochs - 1)
    ...
    def prepare_data(self):
        ...
        dataset = MLMDataset(args=self.args,
                             json_path=json_path, 
