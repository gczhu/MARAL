...
from models.classifier import MultiNonLinearClassifier, SingleLinearClassifier, NormedLinear
...
class BertNER(RobertaPreTrainedModel):
    ...
    def __init__(self, config, args):
        ...
        # self.tokenzier = Tokenizer.from_file(os.path.join(args.bert_config_dir,'tokenizer.json'))
        ...
        self.span_classifier = MultiNonLinearClassifier(input_dim, self.n_class, config.model_dropout)

        if 'q_dim' in args.__dict__:
            self.q_head = MultiNonLinearClassifier(input_dim, args.q_dim, config.model_dropout)
